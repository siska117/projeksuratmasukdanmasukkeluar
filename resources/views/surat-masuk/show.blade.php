        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="d-flex gap-2 mb-4">
                    ...
                    @php
            $rows = [
                ['Nomor Surat', $suratMasuk->no_surat],
                ['Tanggal Surat', \Carbon\Carbon::parse($suratMasuk->tanggal_surat)->translatedFormat('d F Y')],
                ['Tanggal Diterima', \Carbon\Carbon::parse($suratMasuk->tanggal_terima)->translatedFormat('d F Y')],
                ['Asal Surat', $suratMasuk->asal_surat],
            ...
            @endphp
                ...
                <table class="table table-bordered" style="font-size:13.5px">
                    <tbody>
                        ...
                        <tr>
                            <th style="width:35%;background:#f8fafc;font-size:12px;color:#475569;text-transform:uppercase;letter-spacing:.3px">
                                {{ $label }}
                            </th>
                            <td>{{ $val }}</td>
                        </tr>
